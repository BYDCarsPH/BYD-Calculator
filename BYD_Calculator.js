    ...
    function computeSavings() {
      ...
      document.getElementById("savingsEquation").innerHTML =
        `Yearly Savings: (₱${iceCost.toFixed(2)} - ₱${evCost.toFixed(2)}) × ${yearlyKm} km = ₱${savings.toFixed(0)}`;
    }
